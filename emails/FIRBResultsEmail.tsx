        ...
        <Container style={container}>
          ...
          <Section style={section}>
            <Text style={disclaimer}>
              ...
              personal objectives, financial situation, or needs. We have not considered whether
              the information or the hypothetical scenarios generated are suitable for your
              specific circumstances. The results must not be relied upon as professional legal,
              financial, or tax advice, and are not a substitute for consulting a qualified
              professional. Before making any property investment, finance, or legal decisions, you
              should seek independent advice from a licensed financial planner, tax professional, or
              legal practitioner.
            </Text>
          </Section>
