...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    if (body.gross_rental_yield !== undefined)
      updateData.gross_rental_yield = body.gross_rental_yield || null;
    if (body.net_rental_yield !== undefined)
      updateData.net_rental_yield = body.net_rental_yield || null;
    if (body.median_weekly_rent !== undefined)
      updateData.median_weekly_rent = body.median_weekly_rent || null;
    if (body.capital_growth_5yr !== undefined)
      updateData.capital_growth_5yr = body.capital_growth_5yr || null;
    if (body.capital_growth_10yr !== undefined)
      updateData.capital_growth_10yr = body.capital_growth_10yr || null;
    if (body.median_property_value !== undefined)
      updateData.median_property_value = body.median_property_value || null;
    if (body.data_source !== undefined) updateData.data_source = body.data_source || null;
    if (body.data_quality_score !== undefined)
      updateData.data_quality_score = body.data_quality_score || null;
...
export async function DELETE(
  ...
  try {
    ...
    const { error } = await supabase.from("benchmark_data").delete().eq("id", id);
