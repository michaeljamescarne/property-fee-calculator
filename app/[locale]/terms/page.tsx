      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="space-y-6">
          <section>
            ...
            <p>
              By accessing and using the Property Fee Calculator website and services, you accept
          ...
          <section>
            ...
            <p className="mt-4">
              These services are provided for informational purposes only and do not constitute
          ...
          <section>
            ...
            <p className="mb-4">
              All content, features, and functionality of the service are owned by Property Fee
              Calculator and are protected by international copyright, trademark, patent, trade
          ...
          <section>
            ...
            <p className="mb-4">
              To the fullest extent permitted by law, Property Fee Calculator shall not be liable
              for:
            </p>
            <ul className="list-disc list-inside space-y-2">
          ...
          <section>
            ...
            <p>
              You agree to indemnify and hold harmless Property Fee Calculator, its officers,
          ...
          <section>
            ...
            <p>
              ...
              Australia, without regard to conflict of law principles. Any disputes arising from
