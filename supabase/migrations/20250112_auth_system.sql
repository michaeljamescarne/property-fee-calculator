...
CREATE INDEX idx_magic_codes_expires_at ON magic_codes(expires_at);
CREATE INDEX idx_saved_calculations_user_id ON saved_calculations(user_id);
CREATE INDEX idx_saved_calculations_created_at ON saved_calculations(created_at DESC);
CREATE INDEX idx_saved_calculations_is_favorite ON saved_calculations(is_favorite) WHERE is_favorite = TRUE;
...
-- Trigger to increment count on new calculation
