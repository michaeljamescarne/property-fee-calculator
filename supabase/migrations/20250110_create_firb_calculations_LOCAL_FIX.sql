-- Create firb_calculations table (SAFE for local - assumes enums already exist)
-- This version skips enum creation and only creates the table if it doesn't exist
