...
export default function ProjectionChart({ analytics }: ProjectionChartProps) {
  ...
  const equityKey =
    ...
    "FIRBCalculator.investmentAnalytics.projections.tableHeaders.equity"
      ? "Your Equity"
      : t("projections.tableHeaders.equity");
  const cumulativeReturnKey =
    t("projections.tableHeaders.cumulativeReturn") ===
    "FIRBCalculator.investmentAnalytics.projections.tableHeaders.cumulativeReturn"
      ? "Cumulative Return"
      : t("projections.tableHeaders.cumulativeReturn");
  ...
  const CustomTooltip = ({
    ...
    active?: boolean;
    payload?: Array<{ payload: { year: string }; name: string; value: number; color: string }>;
  }) => {
    ...
    <Card className="border border-gray-200 shadow-sm rounded bg-white">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          `FIRBCalculator.investmentAnalytics.projections.title`
            ? `${analytics.yearByYear.length}-Year Investment Projections`
            : t("projections.title", { years: analytics.yearByYear.length })}
        </CardTitle>
        <CardDescription>
          {t("projections.description") ===
          "FIRBCalculator.investmentAnalytics.projections.description"
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs text-blue-600 font-medium mb-1">
              ...
              "FIRBCalculator.investmentAnalytics.projections.startingValue"
                ? "Starting Value"
                : t("projections.startingValue")}
            </p>
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs text-blue-600 font-medium mb-1">
              ...
              "FIRBCalculator.investmentAnalytics.projections.finalValue"
                ? "Final Value"
                : t("projections.finalValue")}
            </p>
            <p className="text-xl font-bold text-blue-700">
          ...
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-xs text-green-600 font-medium mb-1">
              ...
              "FIRBCalculator.investmentAnalytics.projections.yourEquity"
                ? "Your Equity"
                : t("projections.yourEquity")}
            </p>
            ...
            <p className="text-xs text-green-600 mt-1">
              {t("projections.from") === "FIRBCalculator.investmentAnalytics.projections.from"
                ? "from"
                : t("projections.from")}{" "}
              {currency(analytics.loanMetrics.equityAtStart)}
            </p>
          </div>
          ...
          <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <p className="text-xs text-blue-600 font-medium mb-1">
              ...
              "FIRBCalculator.investmentAnalytics.projections.totalROI"
                ? "Total ROI"
                : t("projections.totalROI")}
            </p>
            <p className="text-xl font-bold text-blue-700">{analytics.roi.totalROI.toFixed(1)}%</p>
            <p className="text-xs text-blue-600 mt-1">
              {analytics.roi.annualizedROI.toFixed(1)}%{" "}
              {t("projections.perAnnum") ===
              "FIRBCalculator.investmentAnalytics.projections.perAnnum"
                ? "per annum"
                : t("projections.perAnnum")}
            </p>
          </div>
        ...
        {analytics.breakEven.yearsToCumulativeBreakEven && (
          <div className="p-5 bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20 rounded-xl">
            <h4 className="font-semibold text-foreground mb-3">
              ...
              "FIRBCalculator.investmentAnalytics.projections.breakEven.title"
                ? "Break-Even Analysis"
                : t("projections.breakEven.title")}
            </h4>
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div>
                <p className="text-muted-foreground mb-1">
                  ...
                  "FIRBCalculator.investmentAnalytics.projections.breakEven.cumulativeBreakEven"
                    ? "Cumulative Break-Even"
                    : t("projections.breakEven.cumulativeBreakEven")}
                </p>
                <p className="text-2xl font-bold text-primary">
                  {t("projections.breakEven.year") ===
                  "FIRBCalculator.investmentAnalytics.projections.breakEven.year"
                    ? "Year"
                    : t("projections.breakEven.year")}{" "}
                  {analytics.breakEven.yearsToCumulativeBreakEven}
                </p>
              ...
              {analytics.breakEven.yearsToPositiveCashFlow && (
                <div>
                  <p className="text-muted-foreground mb-1">
                    ...
                    "FIRBCalculator.investmentAnalytics.projections.breakEven.positiveCashFlow"
                      ? "Positive Cash Flow"
                      : t("projections.breakEven.positiveCashFlow")}
                  </p>
              ...
              <div>
                <p className="text-muted-foreground mb-1">
                  ...
                  "FIRBCalculator.investmentAnalytics.projections.breakEven.cashRequired"
                    ? "Cash Required"
                    : t("projections.breakEven.cashRequired")}
                </p>
        ...
        <div>
          <h4 className="text-sm font-semibold text-foreground/70 mb-3 uppercase tracking-wide">
            ...
            "FIRBCalculator.investmentAnalytics.projections.yearByYear"
              ...
              <thead className="bg-muted/50 border-b border-border/40">
                <tr>
                  <th className="text-left p-3 font-semibold">
                    ...
                    "FIRBCalculator.investmentAnalytics.projections.tableHeaders.year"
                      ? "Year"
                      : t("projections.tableHeaders.year")}
                  </th>
                  ...
                  <th className="text-right p-3 font-semibold">
                    ...
                    "FIRBCalculator.investmentAnalytics.projections.tableHeaders.cashFlow"
                      ? "Cash Flow"
                      : t("projections.tableHeaders.cashFlow")}
                  </th>
                  <th className="text-right p-3 font-semibold">
