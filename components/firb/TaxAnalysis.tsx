    ...
    <Card className="border border-gray-200 shadow-sm rounded bg-white">
      <CardHeader>
        ...
        <CardDescription>
          ...
          "FIRBCalculator.investmentAnalytics.taxAnalysis.description"
          ...
          <div className="space-y-3 text-sm">
            <div className="grid md:grid-cols-2 gap-3">
              <div>
                ...
                <p className="font-semibold">
                  {currency(analytics.cashFlow.annual.effectiveIncome)}
                </p>
              </div>
              <div>
                <p className="text-muted-foreground mb-1">
            ...
            <div className="pt-3 border-t border-border/40">
              ...
              <p className="font-semibold text-red-600">
                {currency(
                  Math.max(0, deductions.total - analytics.cashFlow.annual.effectiveIncome)
                )}
              </p>
            </div>
            <div className="pt-3 border-t border-border/40">
