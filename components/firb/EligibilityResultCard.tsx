...
export default function EligibilityResultCard({ eligibility, formData }: EligibilityResultCardProps) {
  ...
  return (
    <Card className="shadow-sm border border-gray-200 overflow-hidden rounded bg-white">
      <div className={`${headerStyles.bgClass} text-white rounded-t -mt-6`}>
        <div className="px-6 py-6">
          <div className="flex items-center justify-between mb-2">
          <CardTitle className="text-2xl font-bold text-white">{t('header')}</CardTitle>
          <Badge 
          ...
          <div className="grid md:grid-cols-2 gap-4 bg-blue-50 p-6 rounded border border-blue-200">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{formData?.citizenshipStatus ? formatCitizenshipStatus(formData.citizenshipStatus) : 'Not specified'}</p>
                {formData?.visaType && (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{formData?.propertyType ? formatPropertyType(formData.propertyType) : 'Not specified'}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{formData?.isFirstHome !== undefined ? getInvestmentPropertyLabel(formData.isFirstHome) : 'Not specified'}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{formData?.entityType ? formatEntityType(formData.entityType) : 'Not specified'}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{formData?.propertyValue ? formatCurrency(formData.propertyValue) : 'Not specified'}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{formData?.state ? formatState(formData.state) : 'Not specified'}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {eligibility.restrictions.map((restriction, index) => (
                <div key={index} className="flex items-start gap-3 p-3 rounded bg-amber-50 border border-amber-200">
          ...
          <div>
            ...
            <div className="space-y-3">
              {eligibility.recommendations.map((recommendation, index) => (
                <div key={index} className="flex items-start gap-3 p-3 rounded bg-blue-50 border border-blue-200">
