      ...
      <CardContent className="pt-6">
          ...
          <AccordionItem value="rental">
            <AccordionTrigger className="text-base font-semibold hover:text-primary">
              <div className="flex items-center gap-2">
                ...
                "FIRBCalculator.investmentAnalytics.inputs.rental.title"
                  ? "Rental Income"
                  : t("inputs.rental.title")}
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground whitespace-nowrap">
                    (${number(inputs.estimatedWeeklyRent * 52)}
                    {t("inputs.rental.perYear") ===
              ...
              <div className="space-y-2">
                <Label>
                  {t("inputs.rental.vacancyRate") ===
                  "FIRBCalculator.investmentAnalytics.inputs.rental.vacancyRate"
                    ? "Vacancy Rate"
                    : t("inputs.rental.vacancyRate")}
                  : {inputs.vacancyRate}%
                </Label>
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.rental.vacancyHelp"
              ...
              <div className="space-y-2">
                <Label>
                  {t("inputs.rental.rentGrowth") ===
                  "FIRBCalculator.investmentAnalytics.inputs.rental.rentGrowth"
                    ? "Annual Rent Growth"
                    : t("inputs.rental.rentGrowth")}
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.rental.rentGrowthHelp"
          ...
          <AccordionItem value="management">
            <AccordionTrigger className="text-base font-semibold hover:text-primary">
              <div className="flex items-center gap-2">
                ...
                "FIRBCalculator.investmentAnalytics.inputs.management.title"
                  ? "Property Management"
                  : t("inputs.management.title")}
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              <div className="flex items-center space-x-2 p-3 rounded-lg border">
                ...
                >
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.management.selfManaged"
              ...
              {!inputs.selfManaged && (
                <>
                  <div className="space-y-2">
                    <Label>
                      {t("inputs.management.managementFee") ===
                      "FIRBCalculator.investmentAnalytics.inputs.management.managementFee"
                    ...
                    />
                    <p className="text-xs text-muted-foreground">
                      {t("inputs.management.managementHelp") ===
                      "FIRBCalculator.investmentAnalytics.inputs.management.managementHelp"
                        ? "Typical: 7-9% of rental income. Estimated"
                        : t("inputs.management.managementHelp")}
                      : $
                      {number(
                        (inputs.estimatedWeeklyRent * 52 * inputs.propertyManagementFee) / 100
                      )}
                      {t("inputs.rental.perYear") ===
                      "FIRBCalculator.investmentAnalytics.inputs.rental.perYear"
                        ? " per year"
                  ...
                  <div className="space-y-2">
                    <Label>
                      ...
                      "FIRBCalculator.investmentAnalytics.inputs.management.lettingFee"
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-muted-foreground">
                        {t("inputs.management.weeksRent") ===
                        "FIRBCalculator.investmentAnalytics.inputs.management.weeksRent"
                          ? "weeks of rent"
                          : t("inputs.management.weeksRent")}{" "}
                        (${number(inputs.estimatedWeeklyRent * inputs.lettingFee)})
                      </span>
                    </div>
                  </div>
                </>
          ...
          <AccordionItem value="financing">
            <AccordionTrigger className="text-base font-semibold hover:text-primary">
              <div className="flex items-center gap-2">
                ...
                "FIRBCalculator.investmentAnalytics.inputs.financing.title"
                  ? "Financing Details"
                  : t("inputs.financing.title")}
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                <Label>
                  {t("inputs.financing.interestRate") ===
                  "FIRBCalculator.investmentAnalytics.inputs.financing.interestRate"
                    ? "Interest Rate"
                    : t("inputs.financing.interestRate")}
                  : {inputs.interestRate.toFixed(2)}% p.a.
                </Label>
                <Slider
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.financing.interestHelp"
              ...
              <div className="space-y-2">
                <Label htmlFor="loan-term">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.financing.loanTerm"
                    ? "Loan Term"
                    : t("inputs.financing.loanTerm")}
                </Label>
                <Select
              ...
              <div className="space-y-2">
                <Label htmlFor="loan-type">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.financing.loanType"
                    ? "Loan Type"
                    : t("inputs.financing.loanType")}
                </Label>
                <Select
                  value={inputs.loanType}
                  onValueChange={(value: "principalAndInterest" | "interestOnly") =>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="principalAndInterest">
                      ...
                      "FIRBCalculator.investmentAnalytics.inputs.financing.principalAndInterest"
                        ? "Principal and Interest"
                        : t("inputs.financing.principalAndInterest")}
                    </SelectItem>
                    <SelectItem value="interestOnly">
                      {t("inputs.financing.interestOnly") ===
                      "FIRBCalculator.investmentAnalytics.inputs.financing.interestOnly"
                        ? "Interest Only"
                        : t("inputs.financing.interestOnly")}
                    </SelectItem>
                  </SelectContent>
              ...
              {inputs.loanType === "interestOnly" && (
                <div className="space-y-2">
                  <Label>
                    {t("inputs.financing.interestOnlyPeriod") ===
                    "FIRBCalculator.investmentAnalytics.inputs.financing.interestOnlyPeriod"
                      ? "Interest Only Period"
                      : t("inputs.financing.interestOnlyPeriod")}
                    : {inputs.interestOnlyPeriod} years
                  </Label>
                  <Slider
          ...
          <AccordionItem value="assumptions">
            <AccordionTrigger className="text-base font-semibold hover:text-primary">
              <div className="flex items-center gap-2">
                ...
                "FIRBCalculator.investmentAnalytics.inputs.assumptions.title"
                  ? "Investment Assumptions"
                  : t("inputs.assumptions.title")}
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              <div className="space-y-2">
                <Label>
                  {t("inputs.assumptions.holdPeriod") ===
                  "FIRBCalculator.investmentAnalytics.inputs.assumptions.holdPeriod"
                    ? "Investment Hold Period"
                    : t("inputs.assumptions.holdPeriod")}
                  : {inputs.holdPeriod} years
                </Label>
                <Slider
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.assumptions.holdPeriodHelp"
              ...
              <div className="space-y-2">
                <Label>
                  {t("inputs.assumptions.capitalGrowth") ===
                  "FIRBCalculator.investmentAnalytics.inputs.assumptions.capitalGrowth"
                    ? "Capital Growth Rate"
                    : t("inputs.assumptions.capitalGrowth")}
                  : {inputs.capitalGrowthRate}% p.a.
                </Label>
                <Slider
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.assumptions.capitalGrowthHelp"
              ...
              <div className="space-y-2">
                <Label>
                  {t("inputs.assumptions.taxRate") ===
                  "FIRBCalculator.investmentAnalytics.inputs.assumptions.taxRate"
                    ? "Marginal Tax Rate"
                    : t("inputs.assumptions.taxRate")}
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.assumptions.taxRateHelp"
              ...
              <div className="space-y-2">
                <Label>
                  {t("inputs.assumptions.sellingCosts") ===
                  "FIRBCalculator.investmentAnalytics.inputs.assumptions.sellingCosts"
                    ? "Selling Costs"
                    : t("inputs.assumptions.sellingCosts")}
                  : {inputs.sellingCosts}%
                </Label>
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.assumptions.sellingCostsHelp"
          ...
          <AccordionItem value="currency">
            <AccordionTrigger className="text-base font-semibold hover:text-primary">
              <div className="flex items-center gap-2">
                ...
                "FIRBCalculator.investmentAnalytics.inputs.currency.title"
            ...
            <AccordionContent className="space-y-4 pt-4">
              <div className="space-y-2">
                <Label htmlFor="home-currency">
                  ...
                  "FIRBCalculator.investmentAnalytics.inputs.currency.homeCurrency"
                    ? "Home Currency"
                    : t("inputs.currency.homeCurrency")}
                </Label>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="AUD">
                      ...
                      "FIRBCalculator.investmentAnalytics.inputs.currency.aud"
                        ? "Australian Dollar (AUD)"
                        : t("inputs.currency.aud")}
                    </SelectItem>
                    <SelectItem value="USD">
                      {t("inputs.currency.usd") ===
                      "FIRBCalculator.investmentAnalytics.inputs.currency.usd"
                        ? "US Dollar (USD)"
                        : t("inputs.currency.usd")}
                    </SelectItem>
                    <SelectItem value="CNY">
                      {t("inputs.currency.cny") ===
                      "FIRBCalculator.investmentAnalytics.inputs.currency.cny"
                        ? "Chinese Yuan (CNY)"
                        : t("inputs.currency.cny")}
                    </SelectItem>
                    <SelectItem value="EUR">
                      {t("inputs.currency.eur") ===
                      "FIRBCalculator.investmentAnalytics.inputs.currency.eur"
                        ? "Euro (EUR)"
                        : t("inputs.currency.eur")}
                    </SelectItem>
                    <SelectItem value="GBP">
                      {t("inputs.currency.gbp") ===
                      "FIRBCalculator.investmentAnalytics.inputs.currency.gbp"
                        ? "British Pound (GBP)"
                        : t("inputs.currency.gbp")}
                    </SelectItem>
                    <SelectItem value="JPY">
                      {t("inputs.currency.jpy") ===
                      "FIRBCalculator.investmentAnalytics.inputs.currency.jpy"
                        ? "Japanese Yen (JPY)"
                        : t("inputs.currency.jpy")}
                    </SelectItem>
                    <SelectItem value="SGD">
                      {t("inputs.currency.sgd") ===
                      "FIRBCalculator.investmentAnalytics.inputs.currency.sgd"
              ...
              {inputs.homeCurrency !== "AUD" && (
                <div className="space-y-2">
                  <Label htmlFor="exchange-rate">
                    ...
                    "FIRBCalculator.investmentAnalytics.inputs.currency.exchangeRate"
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    "FIRBCalculator.investmentAnalytics.inputs.currency.exchangeHelp"
        ...
        <div className="mt-6 p-4 bg-muted/50 rounded-lg border border-border/40">
          <p className="text-sm text-muted-foreground">
            ...
            {t("inputs.note") === "FIRBCalculator.investmentAnalytics.inputs.note"
