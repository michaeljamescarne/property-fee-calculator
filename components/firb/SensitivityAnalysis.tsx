    ...
    return (
      <div className="p-8 border rounded-lg bg-muted/30">
        ...
        <p className="text-muted-foreground">
          Sensitivity analysis data is not available. This section requires investment analytics to
          be enabled.
        </p>
      </div>
    );
    ...
    <Card className="border border-gray-200 shadow-sm rounded bg-white">
      <CardHeader>
        ...
        <CardDescription>
          ...
          "FIRBCalculator.investmentAnalytics.sensitivity.description"
      ...
      <CardContent className="space-y-8">
        ...
        <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-start gap-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-amber-700">
              ...
              "FIRBCalculator.investmentAnalytics.sensitivity.warningDesc"
        ...
        <div>
          <h4 className="text-base font-semibold text-foreground mb-4 flex items-center gap-2">
            ...
            "FIRBCalculator.investmentAnalytics.sensitivity.vacancyImpact"
              ? "Vacancy Impact"
              : t("sensitivity.vacancyImpact")}
            <span className="text-xs font-normal text-muted-foreground">
              (
              {t("sensitivity.vacancyDesc") ===
              "FIRBCalculator.investmentAnalytics.sensitivity.vacancyDesc"
              ...
              <thead className="bg-muted/50 border-b border-border/40">
                <tr>
                  <th className="text-left p-3 font-semibold">
                    ...
                    "FIRBCalculator.investmentAnalytics.sensitivity.vacancyRate"
                      ? "Vacancy Rate"
                      : t("sensitivity.vacancyRate")}
                  </th>
                  <th className="text-right p-3 font-semibold">
                    {t("sensitivity.annualRent") ===
                    "FIRBCalculator.investmentAnalytics.sensitivity.annualRent"
                      ? "Annual Rent"
                      : t("sensitivity.annualRent")}
                  </th>
                  <th className="text-right p-3 font-semibold">
                    {t("cashFlow.netCashFlow") ===
                    "FIRBCalculator.investmentAnalytics.cashFlow.netCashFlow"
                      ? "Net Cash Flow"
                      : t("cashFlow.netCashFlow")}
                  </th>
                  <th className="text-right p-3 font-semibold">
                    {t("sensitivity.impact") ===
                    "FIRBCalculator.investmentAnalytics.sensitivity.impact"
                      ? "Impact"
                      : t("sensitivity.impact")}
                  </th>
                </tr>
                    ...
                    <td className="p-3">
                      ...
                      {scenario.rate === 5 && (
                        <span className="ml-2 text-xs px-2 py-0.5 bg-primary/20 text-primary rounded-full">
                          ...
                          "FIRBCalculator.investmentAnalytics.sensitivity.baseCase"
                            ? "Base Case"
                            : t("sensitivity.baseCase")}
                        </span>
                      )}
          ...
          <p className="text-xs text-muted-foreground mt-3 italic">
            {sensitivity.vacancyImpact && sensitivity.vacancyImpact.length >= 3
              ? t("sensitivity.vacancyNote", {
                  amount: Math.abs(
                    sensitivity.vacancyImpact[2].impact - sensitivity.vacancyImpact[1].impact
                  ).toFixed(0),
                })
        ...
        <div>
          <h4 className="text-base font-semibold text-foreground mb-4 flex items-center gap-2">
            ...
            "FIRBCalculator.investmentAnalytics.sensitivity.interestImpact"
              ? "Interest Rate Impact"
              : t("sensitivity.interestImpact")}
            <span className="text-xs font-normal text-muted-foreground">
              (
              {t("sensitivity.interestDesc") ===
              "FIRBCalculator.investmentAnalytics.sensitivity.interestDesc"
              ...
              <thead className="bg-muted/50 border-b border-border/40">
                <tr>
                  <th className="text-left p-3 font-semibold">
                    ...
                    "FIRBCalculator.investmentAnalytics.sensitivity.interestRate"
                      ? "Interest Rate"
                      : t("sensitivity.interestRate")}
                  </th>
                  <th className="text-right p-3 font-semibold">
                    {t("sensitivity.monthlyRepayment") ===
                    "FIRBCalculator.investmentAnalytics.sensitivity.monthlyRepayment"
                      ? "Monthly Repayment"
                      : t("sensitivity.monthlyRepayment")}
                  </th>
                  <th className="text-right p-3 font-semibold">
                    {t("sensitivity.annualCost") ===
                    "FIRBCalculator.investmentAnalytics.sensitivity.annualCost"
                      ? "Annual Cost"
                      : t("sensitivity.annualCost")}
                  </th>
                  <th className="text-right p-3 font-semibold">
                    {t("sensitivity.cashFlowImpact") ===
                    "FIRBCalculator.investmentAnalytics.sensitivity.cashFlowImpact"
                      ? "Cash Flow Impact"
                      : t("sensitivity.cashFlowImpact")}
                  </th>
                </tr>
        ...
        <div>
          <h4 className="text-base font-semibold text-foreground mb-4 flex items-center gap-2">
            ...
            "FIRBCalculator.investmentAnalytics.sensitivity.growthScenarios"
              ? "Growth Scenarios"
              : t("sensitivity.growthScenarios")}
            <span className="text-xs font-normal text-muted-foreground">
              (
              {t("sensitivity.growthDesc") ===
              "FIRBCalculator.investmentAnalytics.sensitivity.growthDesc"
        ...
        <div className="p-5 bg-gradient-to-r from-muted/50 to-muted/30 border border-border/40 rounded-xl">
          <h4 className="font-semibold text-foreground mb-3">
            ...
            "FIRBCalculator.investmentAnalytics.sensitivity.riskFactors"
              ? "Risk Factors"
              : t("sensitivity.riskFactors")}
          </h4>
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-muted-foreground mb-2">
                ...
                "FIRBCalculator.investmentAnalytics.sensitivity.mostSensitive"
              ...
              <ul className="space-y-1">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    "FIRBCalculator.investmentAnalytics.sensitivity.sensitivityItems.capitalGrowth"
                      ? "Capital Growth"
                      : t("sensitivity.sensitivityItems.capitalGrowth")}
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    "FIRBCalculator.investmentAnalytics.sensitivity.sensitivityItems.interestRate"
                      ? "Interest Rate"
                      : t("sensitivity.sensitivityItems.interestRate")}
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    "FIRBCalculator.investmentAnalytics.sensitivity.sensitivityItems.vacancy"
                      ? "Vacancy Rate"
                      : t("sensitivity.sensitivityItems.vacancy")}
                  </span>
                </li>
            ...
            <div>
              <p className="text-muted-foreground mb-2">
                ...
                "FIRBCalculator.investmentAnalytics.sensitivity.riskMitigation"
                  ? "Risk Mitigation"
                  : t("sensitivity.riskMitigation")}
              </p>
              <ul className="space-y-1">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    "FIRBCalculator.investmentAnalytics.sensitivity.sensitivityItems.highDemand"
                      ? "High Demand Area"
                      : t("sensitivity.sensitivityItems.highDemand")}
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    "FIRBCalculator.investmentAnalytics.sensitivity.sensitivityItems.fixRate"
                      ? "Fixed Rate Loan"
                      : t("sensitivity.sensitivityItems.fixRate")}
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    "FIRBCalculator.investmentAnalytics.sensitivity.sensitivityItems.cashReserves"
                      ? "Cash Reserves"
                      : t("sensitivity.sensitivityItems.cashReserves")}
                  </span>
                </li>
